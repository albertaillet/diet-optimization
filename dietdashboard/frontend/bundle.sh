...
if [ "$1" = "watch" ]; then
  trap "kill 0" EXIT
  esbuild js/index.js --outfile=../static/bundle.js --bundle --minify --platform=browser --watch=forever &
  esbuild styles.css --outfile=../static/bundle.css --minify --watch=forever &
  wait
else
