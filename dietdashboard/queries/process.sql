...
COMMENT ON TABLE final_table IS 'Final table with products, prices, ciqual and agribalyse data';
COMMENT ON COLUMN final_table.product_code IS 'Product code (EAN-13)';
...
COMMENT ON COLUMN final_table.ciqual_code IS 'Ciqual food code (Aliment code)';
COMMENT ON COLUMN final_table.ciqual_name IS 'Ciqual food name in English';
COMMENT ON COLUMN final_table.energy_fibre_kj IS 'Energy in kJ/100g';
COMMENT ON COLUMN final_table.energy_fibre_kcal IS 'Energy in kcal/100g';
COMMENT ON COLUMN final_table.water IS 'Water g/100g';
COMMENT ON COLUMN final_table.protein IS 'Protein g/100g';
COMMENT ON COLUMN final_table.carbohydrate IS 'Carbohydrate g/100g';
COMMENT ON COLUMN final_table.fat IS 'Fat g/100g';
COMMENT ON COLUMN final_table.sugars IS 'Sugars g/100g';
COMMENT ON COLUMN final_table.fructose IS 'Fructose g/100g';
COMMENT ON COLUMN final_table.galactose IS 'Galactose g/100g';
COMMENT ON COLUMN final_table.glucose IS 'Glucose g/100g';
COMMENT ON COLUMN final_table.lactose IS 'Lactose g/100g';
COMMENT ON COLUMN final_table.maltose IS 'Maltose g/100g';
COMMENT ON COLUMN final_table.sucrose IS 'Sucrose g/100g';
COMMENT ON COLUMN final_table.starch IS 'Starch g/100g';
COMMENT ON COLUMN final_table.fiber IS 'Fiber g/100g';
COMMENT ON COLUMN final_table.polyols IS 'Polyols g/100g';
COMMENT ON COLUMN final_table.alcohol IS 'Alcohol g/100g';
COMMENT ON COLUMN final_table.organic_acids IS 'Organic acids g/100g';
COMMENT ON COLUMN final_table.saturated_fat IS 'Saturated fat g/100g';
COMMENT ON COLUMN final_table.monounsaturated_fat IS 'Monounsaturated fat g/100g';
COMMENT ON COLUMN final_table.polyunsaturated_fat IS 'Polyunsaturated fat g/100g';
COMMENT ON COLUMN final_table.fa_04_0 IS 'Fatty acid 04:0 g/100g';
COMMENT ON COLUMN final_table.fa_06_0 IS 'Fatty acid 06:0 g/100g';
COMMENT ON COLUMN final_table.fa_08_0 IS 'Fatty acid 08:0 g/100g';
COMMENT ON COLUMN final_table.fa_10_0 IS 'Fatty acid 10:0 g/100g';
COMMENT ON COLUMN final_table.fa_12_0 IS 'Fatty acid 12:0 g/100g';
COMMENT ON COLUMN final_table.fa_14_0 IS 'Fatty acid 14:0 g/100g';
COMMENT ON COLUMN final_table.fa_16_0 IS 'Fatty acid 16:0 g/100g';
COMMENT ON COLUMN final_table.fa_18_0 IS 'Fatty acid 18:0 g/100g';
COMMENT ON COLUMN final_table.fa_18_1_ole IS 'Fatty acid 18:1 oleic g/100g';
COMMENT ON COLUMN final_table.fa_18_2_lino IS 'Fatty acid 18:2 linoleic g/100g';
COMMENT ON COLUMN final_table.fa_18_3_a_lino IS 'Fatty acid 18:3 alpha-linolenic g/100g';
...
COMMENT ON COLUMN final_table.iron IS 'Iron mg/100g';
COMMENT ON COLUMN final_table.iodine IS 'Iodine µg/100g';
COMMENT ON COLUMN final_table.magnesium IS 'Magnesium mg/100g';
COMMENT ON COLUMN final_table.manganese IS 'Manganese mg/100g';
COMMENT ON COLUMN final_table.phosphorus IS 'Phosphorus mg/100g';
COMMENT ON COLUMN final_table.potassium IS 'Potassium mg/100g';
COMMENT ON COLUMN final_table.selenium IS 'Selenium µg/100g';
COMMENT ON COLUMN final_table.sodium IS 'Sodium mg/100g';
COMMENT ON COLUMN final_table.zinc IS 'Zinc mg/100g';
COMMENT ON COLUMN final_table.retinol IS 'Retinol µg/100g';
COMMENT ON COLUMN final_table.beta_carotene IS 'Beta-carotene µg/100g';
COMMENT ON COLUMN final_table.vitamin_d IS 'Vitamin D µg/100g';
COMMENT ON COLUMN final_table.vitamin_e IS 'Vitamin E mg/100g';
COMMENT ON COLUMN final_table.vitamin_k1 IS 'Vitamin K1 µg/100g';
COMMENT ON COLUMN final_table.vitamin_k2 IS 'Vitamin K2 µg/100g';
COMMENT ON COLUMN final_table.vitamin_c IS 'Vitamin C mg/100g';
COMMENT ON COLUMN final_table.vitamin_b1 IS 'Vitamin B1 mg/100g';
COMMENT ON COLUMN final_table.vitamin_b2 IS 'Vitamin B2 mg/100g';
COMMENT ON COLUMN final_table.vitamin_pp IS 'Vitamin PP mg/100g';
