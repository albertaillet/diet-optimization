...
fetch-all: $(CIQUAL_XML_ZIP) $(CALNUT_0_CSV) $(CALNUT_1_CSV) $(PRICES_PARQUET) $(PRODUCTS_PARQUET) $(AGRIBALYSE_CSV) fetch-exchange-rates check-data
...
# ---------- Generate the checksums of the data files that are not tracked in git. ----------
