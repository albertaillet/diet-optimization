...
unzip_and_process_ciqual: $(CIQUAL_XML_ZIP)
	...
	python scripts/xml_to_csv.py $(CIQUAL_DIR)/alim_2020_07_07.xml $(CIQUAL_DIR)/alim.csv
	python scripts/xml_to_csv.py $(CIQUAL_DIR)/alim_grp_2020_07_07.xml $(CIQUAL_DIR)/alim_grp.csv
	python scripts/xml_to_csv.py $(CIQUAL_DIR)/compo_2020_07_07.xml $(CIQUAL_DIR)/compo.csv
	python scripts/xml_to_csv.py $(CIQUAL_DIR)/sources_2020_07_07.xml $(CIQUAL_DIR)/sources.csv
	python scripts/xml_to_csv.py $(CIQUAL_DIR)/const_2020_07_07.xml $(CIQUAL_DIR)/const.csv
