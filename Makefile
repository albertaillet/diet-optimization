...
nutrient-map-reformat: $(NUTRIENT_MAP_RE)
	DATA_DIR=$(DATA_DIR) ./scripts/nutrient_map/nutrient_map_reformat.py

nutrient-map-update-counts:
	DATA_DIR=$(DATA_DIR) ./scripts/nutrient_map/nutrient_map_update_counts.py

nutrient-map-update-ciqual:
	DATA_DIR=$(DATA_DIR) ./scripts/nutrient_map/nutrient_map_update_ciqual.py
...
$(NNR_EXTRACTED_TABLES): $(NNR_HTML)
	DATA_DIR=$(DATA_DIR) ./scripts/recommendations_nnr2023/recommendations_extract_tables.py

$(NNR_SUMMARY_CSV): $(NNR_EXTRACTED_TABLES)
	DATA_DIR=$(DATA_DIR) ./scripts/recommendations_nnr2023/recommendations_summarize_general.py
...
frontend-copy:
	...
	dietdashboard/frontend/ts/*.ts \
	dietdashboard/frontend/ts/*.tsx \
	dietdashboard/frontend/*.css \
	dietdashboard/frontend/html/**/*.html
